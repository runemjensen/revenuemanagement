...
\begin{figure}[pos=htbp]
	\centering
		\includegraphics{figures/netwBW3.pdf}
...
\begin{figure}[pos=htbp]
	\centering
		\includegraphics{figures/fullFlow2.pdf}
...
\begin{figure}[pos=htbp]
  ...
  %		\centering
  		\includegraphics{figures/GMpolygon.pdf}
		\caption{Polygon of legal combinations\\ of container types.}% A point in the polygon\\ is a convex combination of the shown vectors.}
		\label{fig:GMpolygon}
	\end{minipage}%
	\begin{minipage}{.275\textwidth}
%	\centering
		\includegraphics{figures/terminalVars.pdf}
		\caption{Variables used for\\terminal constraints.}
		\label{fig:terminalVars}
	\end{minipage}%
	\begin{minipage}{.35\textwidth}
	\centering
		\includegraphics{figures/overstowage.pdf}
