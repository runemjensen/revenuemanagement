...
&							&Nodes&Edges&Groups\\
\hline
\parbox[t]{2mm}{\multirow{6}{*}{\rotatebox[origin=c]{90}{Services}}}
&        $R_1$ &  59 &  62 & 251\\
&$R_1$ - $R_2$ & 110 & 116 & 516\\
&$R_1$ - $R_3$ & 147 & 155 & 685\\
&$R_1$ - $R_4$ & 191 & 202 & 919\\
...
\begin{small}
\begin{center}
\begin{tabular}{rr|*{2}{r@{/\hskip3pt}r@{/\hskip3pt}r|}*{1}{r@{/\hskip3pt}r@{/\hskip3pt}r}}
&			&\mult{9}{c}{Included services}\\
&			&	\mult{3}{c|}{$R_1$}&\mult{3}{c|}{$R_1$ to $R_2$}&\mult{3}{c}{$R_1$ to $R_3$}\\	
%\mult{2}{l|}{Network}
%			&     59&      62&     251  &    110&     116&     516  &    147&     155&    685   \\ 
\hline
\parbox[t]{2mm}{\multirow{6}{*}{\rotatebox[origin=c]{90}{Sections}}}
...
\begin{small}
\begin{center}
\begin{tabular}{rr|*{2}{r@{(\hskip3pt}r@{/\hskip3pt}r@{)\hskip4pt}|}*{1}{r@{(\hskip3pt}r@{/\hskip3pt}r@{)}}}
&			&\mult{9}{c}{Included services}\\
&			&	\mult{3}{c|}{$R_1$}&\mult{3}{c|}{$R_1$ to $R_2$}&\mult{3}{c}{$R_1$ to $R_3$}\\	
\hline
\parbox[t]{2mm}{\multirow{6}{*}{\rotatebox[origin=c]{90}{Sections}}}
